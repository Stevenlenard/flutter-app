...
INSERT INTO `complaints` VALUES('1','1','Missed Collection','bobo ang driver','resolved','wag kang matinggera bakla','2026-05-04 08:44:55','0');
INSERT INTO `complaints` VALUES('2','1','Spilled Waste','banana','resolved','banana','2026-05-08 09:04:15','0');
INSERT INTO `complaints` VALUES('3','3','Schedule Issue','hdbsjxhbdsh','resolved','ggvffg','2026-05-08 09:20:32','0');
INSERT INTO `complaints` VALUES('4','2','Driver Behavior','very maldita ang driver','resolved','di ka maganda wag kang mag inarte','2026-05-10 21:25:02','0');
INSERT INTO `complaints` VALUES('5','2','Driver Behavior','bastoe','pending',NULL,'2026-05-11 21:15:00','1');
INSERT INTO `complaints` VALUES('6','2','Schedule Issue','di dumaan','resolved','padadaanin ko','2026-05-13 08:53:49','1');
INSERT INTO `complaints` VALUES('7','2','Driver Behavior','bastos','in_progress',NULL,'2026-05-13 08:54:05','1');
INSERT INTO `complaints` VALUES('8','2','Uncollected Garbage','dapat ayusin ang pag collect','resolved','okay na','2026-05-13 08:54:18','1');
INSERT INTO `complaints` VALUES('9','5','Driver Behavior','walang modo','resolved','ygv','2026-05-14 00:42:17','1');
INSERT INTO `complaints` VALUES('11','2','Driver Behavior','bastos po ang driver','resolved','ftvyby bytf','2026-05-14 19:40:24','0');
INSERT INTO `complaints` VALUES('12','6','Driver Behavior','Walang Kwenta','resolved','noted po','2026-05-16 10:51:50','1');
INSERT INTO `complaints` VALUES('13','8','Uncollected Garbage','ruamnaan dihti pero hindi naman nag notify','resolved','','2026-05-16 23:59:59','0');
INSERT INTO `complaints` VALUES('14','6','Schedule Issue','Hs7skwndjsmsnsbs','resolved','tfv','2026-05-17 09:33:34','1');
INSERT INTO `complaints` VALUES('15','8','Uncollected Garbage','di nakuha','resolved','okay na po','2026-05-17 13:42:06','0');
INSERT INTO `complaints` VALUES('16','8','Schedule Issue','fgjbhbbjj','resolved','jsnzosns','2026-06-16 22:48:16','0');
