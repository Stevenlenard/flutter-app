...
INSERT INTO `access_logs` VALUES('1','1','admin','Successful Login','127.0.0.1','2026-07-17 19:19:32');
INSERT INTO `access_logs` VALUES('2',NULL,'admin','Failed Login Attempt (Invalid Password)','127.0.0.1','2026-07-17 19:20:16');
INSERT INTO `access_logs` VALUES('3','1','admin','Successful Login','127.0.0.1','2026-07-17 19:20:22');
INSERT INTO `access_logs` VALUES('4','1','admin','2FA Required','127.0.0.1','2026-07-17 19:27:07');
INSERT INTO `access_logs` VALUES('5',NULL,'admin','Failed Login Attempt (Invalid Password)','127.0.0.1','2026-07-17 19:27:53');
INSERT INTO `access_logs` VALUES('6','1','admin','2FA Required','127.0.0.1','2026-07-17 19:28:02');
INSERT INTO `access_logs` VALUES('7','1','admin','2FA Required','127.0.0.1','2026-07-17 19:29:43');
INSERT INTO `access_logs` VALUES('8','1','admin','2FA Required','127.0.0.1','2026-07-17 19:32:09');
INSERT INTO `access_logs` VALUES('9','1','admin','2FA Required','10.95.1.91','2026-07-17 19:48:10');
INSERT INTO `access_logs` VALUES('10','1','admin','2FA Required','10.95.1.91','2026-07-17 20:26:59');
INSERT INTO `access_logs` VALUES('11','1','admin','2FA Required','10.95.1.91','2026-07-17 20:29:02');
INSERT INTO `access_logs` VALUES('12','1','admin','2FA Required','10.95.1.91','2026-07-17 20:30:44');
INSERT INTO `access_logs` VALUES('13','1','admin','2FA Required','10.95.1.91','2026-07-17 20:35:28');
INSERT INTO `access_logs` VALUES('14','1','admin','Successful Login','10.95.1.91','2026-07-17 21:01:46');
INSERT INTO `access_logs` VALUES('15','7','steve','Successful Login','10.95.1.91','2026-07-17 21:05:47');
INSERT INTO `access_logs` VALUES('16','9','stevie','Successful Login (Resident)','10.95.1.91','2026-07-17 21:07:04');
INSERT INTO `access_logs` VALUES('17','1','admin','Successful Login','10.95.1.91','2026-07-17 21:08:17');
INSERT INTO `access_logs` VALUES('18','1','admin','Successful Login','10.95.1.91','2026-07-17 21:13:18');
INSERT INTO `access_logs` VALUES('19','9','stevie','Successful Login (Resident)','10.95.1.91','2026-07-17 21:14:24');
INSERT INTO `access_logs` VALUES('20','1','admin','Successful Login','10.95.1.91','2026-07-17 21:16:09');
INSERT INTO `access_logs` VALUES('21','1','admin','Successful Login','10.95.1.91','2026-07-17 21:55:24');
INSERT INTO `access_logs` VALUES('22','9','stevie','Successful Login (Resident)','10.95.1.91','2026-07-17 21:55:48');
INSERT INTO `access_logs` VALUES('23','1','admin','Successful Login','10.95.1.91','2026-07-17 21:56:32');
INSERT INTO `access_logs` VALUES('24','1','admin','Successful Login','10.95.1.91','2026-07-17 22:16:30');
INSERT INTO `access_logs` VALUES('25','1','admin','Successful Login','10.95.1.91','2026-07-17 22:22:34');
INSERT INTO `access_logs` VALUES('26','1','admin','Successful Login','10.95.1.91','2026-07-17 22:28:39');
INSERT INTO `access_logs` VALUES('27','1','admin','Successful Login','10.95.1.91','2026-07-17 22:35:15');
...
INSERT INTO `complaints` VALUES('5','2','Driver Behavior','bastoe','in_progress','','2026-05-11 13:15:00','1');
INSERT INTO `complaints` VALUES('6','2','Schedule Issue','di dumaan','resolved','padadaanin ko','2026-05-13 00:53:49','1');
INSERT INTO `complaints` VALUES('7','2','Driver Behavior','bastos','in_progress','','2026-05-13 00:54:05','1');
...
INSERT INTO `complaints` VALUES('15','8','Uncollected Garbage','di nakuha','resolved','ok','2026-05-17 05:42:06','0');
INSERT INTO `complaints` VALUES('16','9','Uncollected Garbage','huyyyy','in_progress','','2026-07-02 13:53:05','0');
INSERT INTO `complaints` VALUES('17','9','Driver Behavior','hayst','pending',NULL,'2026-07-17 21:07:18','0');
INSERT INTO `complaints` VALUES('18','9','Uncollected Garbage','teset','pending',NULL,'2026-07-17 21:14:40','0');
INSERT INTO `complaints` VALUES('19','9','Driver Behavior','test','pending',NULL,'2026-07-17 21:56:05','0');
...
INSERT INTO `password_resets` VALUES('16','princebarola191@gmail.com','019776','2026-07-17 14:03:05','2026-07-17 19:48:05');
INSERT INTO `password_resets` VALUES('23','nevetsespaldon@gmail.com','055122','2026-07-17 20:51:04','2026-07-17 20:36:04');
...
INSERT INTO `residents` VALUES('1','resident1','Juan Dela Cruz','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi','resident@email.com','09675552589','Purok 2','Brgy. Balintawak, Lipa City',NULL,'1','2026-05-03 23:58:05','0',NULL,NULL,NULL,'1','1');
INSERT INTO `residents` VALUES('2','resident','Prince Barola','$2y$10$agl40dUKa9DSg4KFE4u.duS/ychHzQwLyP/NroSkcPkfANwNbPIky','princebarola191@gmail.com','09221543697','Purok 2','purok 2 balintawak',NULL,'1','2026-05-08 01:11:02','0',NULL,NULL,NULL,'1','1');
INSERT INTO `residents` VALUES('3','resi','resi buli','$2y$10$kMF4Xvxu1qsBG6y79BrM0e7hs5xki6XqxsZz.xo6vtPX2IK6Iu2..','resi@shibuli.com','09675582593','Purok 2','pablitos dormitory balintawak road',NULL,'1','2026-05-08 01:20:03','0',NULL,NULL,NULL,'1','1');
INSERT INTO `residents` VALUES('4','Joven Espaldon','Joven Espaldon','$2y$10$wm7TzIRMSiXd4EV.hvfg9OouEA7cnorphg9VWBDHOdBuBDQyJLGYi','joven@gmail.com','+6391234567','Purok 3','Balintawal Lipa city',NULL,'1','2026-05-10 13:37:03','0',NULL,NULL,NULL,'1','1');
INSERT INTO `residents` VALUES('5','Althea','Althea Untalan','$2y$10$JfSQVXaygaKQW5ElAQKwxezl4Qc/WAQDKXVpZoRFhvCP3Yc66yxE6','Althea@gmail.com','12345678901','Purok 4','barangay balintawak purok dos',NULL,'1','2026-05-13 16:41:20','0',NULL,NULL,NULL,'1','1');
INSERT INTO `residents` VALUES('6','Joven Noblefranca','Joven Noblefranca','$2y$10$WZB3wRFfsKQ2JUntJ0jGw.11TDEp0DGU6fFjg5rkBwpo9TBA73Avq','jovenoblefranca23@gmail.com','09123456789','Dos Riles','Balintawak',NULL,'1','2026-05-16 02:49:20','0',NULL,NULL,NULL,'1','1');
INSERT INTO `residents` VALUES('8','Prince','Prince Barola','$2y$10$XvioiF12fZznJjapP1PQZ.hQhYlB5sb6NZS9UJK1.x9lfNKmUQht6','princebarola7@gmail.com','09231648270','Purok 2','barangray balintawak, pablitos dormitory',NULL,'1','2026-05-16 15:56:35','0',NULL,NULL,NULL,'1','1');
INSERT INTO `residents` VALUES('9','stevie','Stevie Espaldon','$2y$10$Xx/Gcup2q3wZckof2A.va.hPqnMGovAG5BE.hAYMzJ0Ol95gODxny','stevie@gmail.com','093456789112','Purok 3','Purok 3',NULL,'1','2026-07-01 23:06:12','0',NULL,NULL,NULL,'1','1');
INSERT INTO `residents` VALUES('10','alden','Alden alden','$2y$10$RJRlp28MFDa1H7sCu91wlOXUE7beTbSbfRG6YWiyrfT7AIDKzQ.7a','alden@gmail.com','096767676771','Riverside','067c barangay',NULL,'1','2026-07-02 15:37:31','1',NULL,NULL,NULL,'1','1');
...
INSERT INTO `users` VALUES('1','admin','System Admin','nevetsespaldon@gmail.com','$2y$10$EDfif75ZMa2DUwMKTX9i7uvBsRnConbbHLE2f6KJwrOlVsrLsdR72',NULL,'ADMIN-000',NULL,'admin','2026-05-03 23:58:05','0','0','1','1',NULL,NULL,NULL,'1','1','1');
INSERT INTO `users` VALUES('6','Eman','Eman Masapol','Eman@gmail.com','$2y$10$HZ0pWwppnRCJ/aR7FIrubOlw/YsgcQetBshYHFH1.BMEWJgNjLG5.','09261345267','',NULL,'driver','2026-05-15 21:15:38','0','0','1','1',NULL,NULL,NULL,'1','1','1');
INSERT INTO `users` VALUES('7','steve','Steve Espaldon','steve@gmail.com','$2y$10$qg5B5z3vJY.Le.Am3FqOEe365CUyPNhn5alEk8q9QZ99HV1vM7Hfa','09072759541','',NULL,'driver','2026-05-16 02:49:18','0','0','1','1',NULL,NULL,NULL,'1','1','1');
